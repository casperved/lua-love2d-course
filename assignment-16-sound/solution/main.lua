-- Assignment 16: Sound Effects — SOLUTION
-- All TODOs are filled in. Sound files (hit.ogg, dodge.ogg, music.ogg) are
-- loaded safely with pcall so the game still runs if they are missing.
-- Download free sounds from https://freesound.org and place them here.
...
-- ============================================================
-- Load sounds (TODO 1 — complete)
-- Place hit.ogg, dodge.ogg, and music.ogg next to this file.
-- ============================================================
...
-- ============================================================
-- Start background music looping (TODO 2 — complete)
-- ============================================================
if music then
...
function love.update(dt)
    ...
    for i = #asteroids, 1, -1 do
        ...
        if a.y - a.radius > 620 then
            ...
            playSound(dodgeSound)           -- TODO 3 — complete
        ...
        elseif a.x > player.x - a.radius and a.x < player.x + player.w + a.radius and
            ...
            table.remove(asteroids, i)
            lives = lives - 1
            playSound(hitSound)             -- TODO 4 — complete
            triggerFlash(1, 0.2, 0.2)       -- red flash

            if lives <= 0 then
                gameOver = true
                if music then music:stop() end  -- TODO 5 — complete
            end
        end
    end
end
...
function love.keypressed(key)
    if key == "r" and gameOver then
        ...
        -- Restart music from the beginning (TODO 6 — complete)
        if music then
            music:seek(0)
            music:play()
        end
