-- Assignment 22 Starter: Multiple Files
-- An asteroid-dodging game split across four Lua files.
-- Your job: implement the two missing functions in utils.lua and asteroids.lua.
-- (This file is already complete — the TODOs are in the other modules.)

SCREEN_W = 800
SCREEN_H = 600

-- These three lines load the other files in the same folder.
-- require("player") runs player.lua and gives back its table.
utils     = require("utils")
...
function love.update(dt)
    ...
    -- Collision check — uses the distance function you will write in utils.lua
...
function love.draw()
    ...
    if state == "title" then
        ...
        -- Hint: collisions won't work until you fill in the TODOs in utils.lua and asteroids.lua
        love.graphics.setColor(0.5, 1, 0.6)
        drawCenteredText("Open utils.lua and asteroids.lua to fill in the TODOs!", 290, "small")

        love.graphics.setColor(1, 1, 0.4)
        drawCenteredText("Press SPACE to start", 340)
